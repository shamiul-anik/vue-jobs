...
describe('JobCard.vue', () => {
  const mockJob = {
    ...
    type: 'Full-Time',
    description: 'We are seeking a talented Front-End Developer with expertise in Vue.js and modern web development practices. This is a great opportunity to work with cutting-edge technologies.',
    salary: '$70K - $80K / Year',
    location: 'Boston, MA',
